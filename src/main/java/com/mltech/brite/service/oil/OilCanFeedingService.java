...
@Service
public class OilCanFeedingService {
	...
	public OilCanFeedingDetailResponse getOilCanFeedingDetail(GetOilCanFeedingDetailRequest pojo){
		
		OilCanFeedingDetailResponse response = null;
		OilCanFeeding cond = new OilCanFeeding();
		
		List<OilCanFeeding> list = oilCanFeedingDao.findEntityListByCond(cond);
